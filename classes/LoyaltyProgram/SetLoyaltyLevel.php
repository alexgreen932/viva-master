...
class SetLoyaltyLevel {
	...
	public function __construct() {
		add_action( 'show_user_profile', array( $this, 'add_loyalty_level_field' ), 5 );
		add_action( 'edit_user_profile', array( $this, 'add_loyalty_level_field' ), 5 );
		add_action( 'personal_options_update', array( $this, 'save_loyalty_level_field' ) );
		add_action( 'edit_user_profile_update', array( $this, 'save_loyalty_level_field' ) );
	}
