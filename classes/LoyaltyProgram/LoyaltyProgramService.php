...
class LoyaltyProgramService {
	...
	public function __construct() {
		...
		add_action( 'woocommerce_cart_calculate_fees', array( $this, 'apply_loyalty_discount' ) );

		// Update loyalty level after order is completed
		add_action( 'woocommerce_order_status_completed', array( $this, 'update_loyalty_level' ), 10, 1 );

		// Add loyalty info to emails
		add_filter( 'woocommerce_email_order_meta', array( $this, 'add_loyalty_info_to_email' ), 10, 3 );
	}
	...
	public function get_loyalty_data( $user_id ) {
		...
		return array(
			...
			'discounts'     => $discounts[ $loyalty_level ] ?? array(),
